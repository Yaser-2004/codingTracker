...
export default function PracticeProblems() {
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8 flex flex-col items-center">
      <h1 className="text-4xl font-bold text-center">Sharpen your skills with practice problems and level up!</h1>
      ...
      <div className="mt-6 flex gap-4">
        <button className="bg-purple-500 text-white px-4 py-2 rounded">Recently faced Problems</button>
        <button className="bg-purple-500 text-white px-4 py-2 rounded">Starred Problems</button>
      </div>
      ...
      <button className="mt-6 bg-purple-500 text-white px-4 py-2 rounded">+ More Languages</button>
    </div>
  );
}
